...
author: |
  Group4: Johanna Enright - 30303537, Uyoyoumena Orona - 30295200,
...
# 1. Purpose
## Domain:
\indent Our project looks at forest fire data in Alberta between 2006 and 2024. The data set gives information on total area burned, fire spread rate, causes of fires, as well as fire types, and time stamps and location coordinates [@wildfire_data_dictionary]{}. We are narrowing our focus down to specifically focus on how weather factors, like wind speed, contribute to fire spread rate as well as how the cause of fires (specifically lightning) may be changing over time due to climate change.
...
\indent **Question 2** :
We will investigate this topic further by performing a simple linear regression assessing fire spread rate as a function of wind speed.
$$
